...
public class AssetControllerTest {
    ...
    void createAsset_ReturnsCreatedAsset() throws Exception {
        when(assetService.createAsset(any(AssetRequestDTO.class))).thenReturn(testAssetDTO);
    ...
    void getAllAssets_ReturnsPage() throws Exception {
        ...
        when(assetService.getAllAssets(any(), any(), any(), any(Pageable.class))).thenReturn(page);
