    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {isAdmin || isManager
            ...
            : "Here's your personal asset and ticket summary."}
        </p>
      </div>
      ...
      isAdmin || isManager ? (
        (() => {
          ...
          if (isAdmin) {
            // Admin: asset-focused stats only — no ticket counts
            return (
          ...
          // Manager: full stats including tickets
          return (
      ...
      {/* Admin: single recent-assets panel */}
      {isAdmin && (
        <div className="bg-card rounded-xl border shadow-card p-5">
      ...
      {/* Manager: two-panel grid with assets + active tickets */}
      {isManager && (
